...
* execute the command `java -Djarmode=tools -jar layers-dockerfile-0.0.1-SNAPSHOT.jar`
* execute the command `java -Djarmode=tools -jar layers-dockerfile-0.0.1-SNAPSHOT.jar list-layers`
* create a temporary directory `mkdir t`
* navigate to the new directory `cd t`
* execute the command `java -Djarmode=tools -jar ../layers-dockerfile-0.0.1-SNAPSHOT.jar extract --layers --destination .`
