...
public class Zone {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ARecord aRecordRoot = new Builders.ARecord().name(origin).ip("192.168.1.1").build();

    ARecord aRecordNs = new Builders.ARecord().name("ns.example.test.").ip("192.168.1.1").build();
